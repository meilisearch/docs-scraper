...
The scraper tool needs a config file to know which content you want to scrape. This is done by providing **selectors** (e.g. the HTML tag/id/class). The config file will be passed as an argument, so you can name your file whatever you want.
